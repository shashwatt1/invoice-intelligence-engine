...
@router.get(
    ...
    description=(
        ...
        "- `format=pdi` — fixed-width PDI import format (header, detail, and "
        "trailer record layout all confirmed against real PDI samples; item "
        "code, description, quantity, cost, batch number, return/credit sign, "
        "and prepaid-tax trailer are calculated from confirmed business rules; "
        "the exact digit layout of the cost fields, and fuel-surcharge trailer "
        "content, are not yet verified — see docs/PDI_OPEN_QUESTIONS.md before "
        "relying on this for a live import). "
