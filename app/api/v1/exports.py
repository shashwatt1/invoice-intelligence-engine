...
@router.get(
    ...
    description=(
        ...
        "quantity, cost, batch number, and return/credit sign are calculated "
        "from confirmed business rules; the exact digit layout of the cost "
        "fields is not yet verified against a ground-truth PDI file — "
