...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn("text-[0.83rem] text-muted-foreground", className)}
      {...props}
    />
  )
}
